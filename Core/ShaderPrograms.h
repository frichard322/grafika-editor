...
namespace cagd
{
    ...
    public:
        ...
        GLboolean SetUniformVariable1iv(const GLchar *name, GLsizei count, GLint* value) const;
        GLboolean SetUniformVariable2iv(const GLchar *name, GLsizei count, GLint* value) const;
        GLboolean SetUniformVariable3iv(const GLchar *name, GLsizei count, GLint* value) const;
        GLboolean SetUniformVariable4iv(const GLchar *name, GLsizei count, GLint* value) const;
        ...
        GLboolean SetUniformVariable1fv(const GLchar *name, GLsizei count, GLfloat* value) const;
        GLboolean SetUniformVariable2fv(const GLchar *name, GLsizei count, GLfloat* value) const;
        GLboolean SetUniformVariable3fv(const GLchar *name, GLsizei count, GLfloat* value) const;
        GLboolean SetUniformVariable4fv(const GLchar *name, GLsizei count, GLfloat* value) const;
