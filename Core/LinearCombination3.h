...
namespace cagd
{
    ...
    public:
        ...
        inline ColumnMatrix<DCoordinate3> GetData() const
        {
            return _data;
        }
        inline void SetData(const ColumnMatrix<DCoordinate3>& data)
        {
            _data = data;
        }
        inline void SetData(GLuint index, const DCoordinate3& coord)
        {
            _data[index] = coord;
        }
