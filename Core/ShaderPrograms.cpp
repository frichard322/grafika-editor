...
GLboolean ShaderProgram::SetUniformVariable1iv(const GLchar *name, GLsizei count, GLint* value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable2iv(const GLchar *name, GLsizei count, GLint* value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable3iv(const GLchar *name, GLsizei count, GLint* value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable4iv(const GLchar *name, GLsizei count, GLint* value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable1fv(const GLchar *name, GLsizei count, GLfloat* value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable2fv(const GLchar *name, GLsizei count, GLfloat* value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable3fv(const GLchar *name, GLsizei count, GLfloat* value) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable4fv(const GLchar *name, GLsizei count, GLfloat* value) const
{
    if (!_program)
        return GL_FALSE;
